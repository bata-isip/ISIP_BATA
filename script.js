...
if(subject==="Filipino Vocabulary"){
  if(lesson==="Hayop"){
    qs.push({q:"Ano ang 'aso'?", a:"Dog", choices:shuffle(["Dog","Cat","Bird","Fish"])});
    qs.push({q:"Ano ang 'pusa'?", a:"Cat", choices:shuffle(["Cat","Dog","Car","Apple"])});
    qs.push({q:"Ano ang 'ibon'?", a:"Bird", choices:shuffle(["Bird","Fish","Elephant","Monkey"])});
    qs.push({q:"Ano ang 'isda'?", a:"Fish", choices:shuffle(["Fish","Bird","Dog","Cat"])});
    qs.push({q:"Ano ang 'baka'?", a:"Cow", choices:shuffle(["Cow","Pig","Sheep","Goat"])});
    qs.push({q:"Ano ang 'kambing'?", a:"Goat", choices:shuffle(["Goat","Sheep","Dog","Cat"])});
    qs.push({q:"Ano ang 'manok'?", a:"Chicken", choices:shuffle(["Chicken","Duck","Pig","Cow"])});
    qs.push({q:"Ano ang 'kalabaw'?", a:"Carabao", choices:shuffle(["Carabao","Dog","Cat","Fish"])});
    qs.push({q:"Ano ang 'baboy'?", a:"Pig", choices:shuffle(["Pig","Cow","Goat","Sheep"])});
    qs.push({q:"Ano ang 'ibon' na hindi lumilipad?", a:"Penguin", choices:shuffle(["Penguin","Duck","Eagle","Ostrich"])});
  }

  if(lesson==="Kulay"){
    qs.push({q:"Ano ang kulay ng langit?", a:"Asul", choices:shuffle(["Asul","Pula","Dilaw","Berde"])});
    qs.push({q:"Ano ang kulay ng saging?", a:"Dilaw", choices:shuffle(["Dilaw","Berde","Pula","Itim"])});
    qs.push({q:"Ano ang kulay ng damo?", a:"Berde", choices:shuffle(["Berde","Puti","Pula","Dilaw"])});
    qs.push({q:"Ano ang kulay ng apoy?", a:"Pula", choices:shuffle(["Pula","Asul","Berde","Kulay-abo"])});
    qs.push({q:"Ano ang kulay ng niyebe?", a:"Puti", choices:shuffle(["Puti","Itim","Berde","Pula"])});
    qs.push({q:"Ano ang kulay ng uling?", a:"Itim", choices:shuffle(["Itim","Puti","Asul","Berde"])});
    qs.push({q:"Ano ang kulay ng puno?", a:"Kayumanggi", choices:shuffle(["Kayumanggi","Berde","Pula","Dilaw"])});
  }

  if(lesson==="Numero"){
    qs.push({q:"Ilang daliri meron tayo sa kamay?", a:"10", choices:shuffle(["10","5","8","12"])});
    qs.push({q:"Ano ang kasunod ng 2?", a:"3", choices:shuffle(["3","1","4","5"])});
    qs.push({q:"Ilang araw meron sa isang linggo?", a:"7", choices:shuffle(["7","5","8","10"])});
    qs.push({q:"Ano ang bago sa 5?", a:"4", choices:shuffle(["4","3","2","6"])});
    qs.push({q:"Ilang buwan meron sa isang taon?", a:"12", choices:shuffle(["12","10","8","6"])});
  }

  if(lesson==="Prutas"){
    qs.push({q:"Ano ang prutas na pula?", a:"Mansanas", choices:shuffle(["Mansanas","Pipino","Sibuyas","Patatas"])});
    qs.push({q:"Ano ang prutas na dilaw at maasim?", a:"Lemon", choices:shuffle(["Lemon","Mangga","Ubas","Saging"])});
    qs.push({q:"Ano ang prutas na kilala sa Pilipinas?", a:"Mangga", choices:shuffle(["Mangga","Mansanas","Pera","Pakwan"])});
    qs.push({q:"Ano ang maliit at pulang prutas?", a:"Strawberry", choices:shuffle(["Strawberry","Ubas","Saging","Mansanas"])});
    qs.push({q:"Ano ang ubas sa English?", a:"Grapes", choices:shuffle(["Grapes","Banana","Mango","Apple"])});
  }
}
  return qs;
}
